...
export default function Create({ availableFonts }: { availableFonts: Record<string, { name: string; path: string }> }) {
    const { data, setData, post, processing, errors } = useForm<{
        ...
        sync_to_capstar: boolean;
        capstar_course_number: string;
    }>({
        title: '',
        description: '',
        thumbnail: null,
        ...
        certificate_font: 'dejavu',
        exam_duration: 30,
        is_published: false,
        sync_to_capstar: false,
            ...
            <div className="space-y-4 p-4 sm:p-6 lg:p-8">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm">Add a new course</p>
                    </div>
                </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="grid gap-6 sm:grid-cols-2">
                                <div className="space-y-2">
                                    ...
                                    />
                                    <p className="text-muted-foreground text-xs">Set to 0 for free course</p>
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-muted-foreground text-xs">Pilih font untuk text di sertifikat (nama, course, nilai, tanggal)</p>
                            ...
                            <div className="flex items-center space-x-2">
                                <Checkbox
                                    ...
                                    onCheckedChange={(checked) => {
                                        const isChecked: boolean = checked === true;
                                        setData('is_published', isChecked);
                                    }}
                                />
                            ...
                            <div className="space-y-4 rounded-lg border p-4">
                                ...
                                {data.sync_to_capstar && (
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-muted-foreground text-xs">
                                            Map this course to Capstar course number (1-5). Completion will be synced automatically.
                                        </p>
