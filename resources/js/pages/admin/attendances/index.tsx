        ...
        <>
            ...
            <div className="space-y-4 sm:space-y-6">
                <div>
                    ...
                    <p className="text-sm text-muted-foreground sm:text-base">Track student attendance in Zoom meetings</p>
                </div>
                            ...
                            {attendances.data.length === 0 ? (
                                ...
                                attendances.data.map((attendance) => (
                                    <TableRow key={attendance.id}>
                                        <TableCell>
                                            <div>
                                                ...
                                                {!attendance.user && attendance.zoom_user_id && (
                                                    <div className="text-xs text-muted-foreground">ID: {attendance.zoom_user_id}</div>
                                                )}
                                            </div>
                                        </TableCell>
                                        <TableCell>
                                        ...
                                        <TableCell>
                                            {attendance.check_out_time ? formatDateTime(attendance.check_out_time) : '-'}
                                        </TableCell>
                                        <TableCell>
